...
export const HomeCareCarousel = () => {
  ...
  return (
    <div className="block relative w-full h-64 sm:h-80 lg:h-96 overflow-hidden rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-lg sm:shadow-xl lg:shadow-2xl">
      {/* Slides */}
      <div
      ...
      >
        {slides.map((slide, index) => (
          ...
          >
            {/* Conteúdo do Slide */}
            <div className="text-center z-10 px-0 sm:px-4 lg:px-6 w-full max-w-sm mx-auto">
              <div className="w-20 h-20 sm:w-28 sm:h-28 lg:w-36 lg:h-36 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center mx-auto mb-2 sm:mb-3 lg:mb-4 shadow-glow animate-pulse-glow">
                {slide.icon}
              </div>
